...
export const PHASE_BOUNDARY_STEPS: Partial<Record<string, RevealPhase>> = {
  ...
  [PROTOCOL_STEPS.OVERVIEW_AREAS_TO_IMPROVE_BIOMARKERS]: 'overview',
...
const PROTOCOL_STEPPER_STEPS = [
  ...
  { id: PROTOCOL_STEPS.OVERVIEW_AREAS_TO_IMPROVE },
  { id: PROTOCOL_STEPS.OVERVIEW_AREAS_TO_IMPROVE_BIOMARKERS },
